...
<a href="/category/show/{{ $id }}" class="cursor-pointer bg white w-auto h-54 p-2 shadow-lg space-y-3 rounded-lg" wire:navigate>
    <img class="h-32 w-full" src="{{ asset('storage/' . $source)}}" alt="pet">
